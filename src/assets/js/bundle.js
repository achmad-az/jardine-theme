...
require('../../../libraries/owl-carousel/dist/owl.carousel');
require('../../../libraries/js-social/jssocials');
window.Masonry = require('../../../assets/js/masonry');
window.WOW = require('../../../assets/js/wow').WOW;
require('../../../assets/js/bootstrap-lightbox.min');
